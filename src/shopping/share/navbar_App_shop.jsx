                                ...
                                >
                                    ...
                                    <div className="flex gap-4">
                                        <div>
                                            ...
                                            <form className="form" onSubmit={handleSubmit(onSubmit_signUp)}>
                                                ...
                                                {state2.emailFind ? <div className="text-center my-1 text-red-400 font-bold"> {state2.massage} </div> : null}
                                            </form>
                                        </div>

                                        <div>
                                            <div className="title"> sign in </div>
                                            <form className="form" onSubmit={handleSubmit(onSubmit_login)}>
                                                <div className="input-group">
                                                    <label htmlFor="email"> email </label>
                                                    <input type="email" name="email" id="email"
                                                        placeholder="email" onChange={i => setEmail(i.target.value)} />
                                                ...
                                                <div className="input-group">
                                                    ...
                                                    <div className="text-center my-1 text-red-400 font-bold"> {state2.massage} </div>
